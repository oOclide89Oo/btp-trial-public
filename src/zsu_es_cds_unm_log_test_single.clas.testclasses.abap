"!@testing SRVB:ZSU_ES_SB_UNM_LOG_SINGLE
...
METHOD READ_ENTITY.
DATA:
  ls_entity_key    TYPE zsu_s_cds_log_single,
  ls_business_data TYPE zsu_s_cds_log_single,
...
lo_resource = lo_client_proxy->create_resource_for_entity_set( 'ZSU_CDS_ES_SINGLE_LOG' )->navigate_with_key( ls_entity_key ).
...
METHOD READ_LIST.
DATA:
  lt_business_data TYPE TABLE OF zsu_s_cds_log_single,
  lo_client_proxy  TYPE REF TO /iwbep/if_cp_client_proxy,
...
* lt_range_LOGID TYPE RANGE OF zsu_es_fieldname,
...
lo_request = lo_client_proxy->create_resource_for_entity_set( 'ZSU_CDS_ES_SINGLE_LOG' )->create_request_for_read( ).
