...
lo_resource = lo_client_proxy->create_resource_for_entity_set( 'ZCS_CDS_UNM_LOG' )->navigate_with_key( ls_entity_key ).
...
lo_request = lo_client_proxy->create_resource_for_entity_set( 'ZCS_CDS_UNM_LOG' )->create_request_for_read( ).
