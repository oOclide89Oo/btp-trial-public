CLASS zsu_es_cl_query_single DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zsu_es_cl_query_single IMPLEMENTATION.
...
*    LOGICA DI LETTURA
     ...
     lt_business_data = zsu_cl_log_single=>read_log_api( EXPORTING iv_log_id = CONV zsu_es_fieldname( lv_logid )
