CLASS zcs_cl_rap_generator DEFINITION
  PUBLIC
...
CLASS zcs_cl_rap_generator IMPLEMENTATION.
...
json_string = ' { ' && |\r\n| &&
    ...
    ' "prefix": "CORSO_", ' && |\r\n| &&
    ' "suffix": "", ' && |\r\n| &&
    ' "transportrequest": "TRLK908969", ' && |\r\n| &&
    ' "draftenabled": true, ' && |\r\n| &&
    ' "hierarchy": { ' && |\r\n| &&
    '    "entityName": "CONFIG", ' && |\r\n| &&
    '    "dataSource": "ZCORSO_C_CONFIG", ' && |\r\n| &&
    '    "objectId": "fieldname", ' && |\r\n| &&
    '    "localInstanceLastChangedAt": "local_last_changed_at", ' && |\r\n| &&
    '    "etagMaster": "local_last_changed_at", ' && |\r\n| &&
    '    "totalEtag" : "last_changed_at", ' && |\r\n| &&
