CLASS zcs_cl_rap_gnr_su DEFINITION
  PUBLIC
...
CLASS zcs_cl_rap_gnr_su IMPLEMENTATION.
...
json_string = ' { ' && |\r\n| &&
    ...
    ' "draftenabled": true, ' && |\r\n| &&
    ' "hierarchy": { ' && |\r\n| &&
    '    "entityName": "SU_MASTER", ' && |\r\n| &&
    '    "dataSource": "ZRAP_SU_DB", ' && |\r\n| &&
    '    "objectId": "fieldname", ' && |\r\n| &&
    '    "localInstanceLastChangedAt": "local_last_changed_at", ' && |\r\n| &&
    '    "etagMaster": "local_last_changed_at", ' && |\r\n| &&
    '    "totalEtag" : "last_changed_at", ' && |\r\n| &&
    '         "children": [ ' && |\r\n| &&
    '            { ' && |\r\n| &&
    '                "entityName": "SU_DETAIL", ' && |\r\n| &&
    '                "dataSource": "ZRAP_SU_DETAIL", ' && |\r\n| &&
