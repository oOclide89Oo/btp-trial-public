CLASS LHC_AC_MASTER_S DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      GET_INSTANCE_FEATURES FOR INSTANCE FEATURES
        IMPORTING
          KEYS REQUEST requested_features FOR AC_MASTER_S
        RESULT result,
      SELECTTRANSPORT FOR MODIFY
        IMPORTING
          KEYS FOR ACTION AC_MASTER_S~selectTransport
        RESULT result.
ENDCLASS.

CLASS LHC_AC_MASTER_S IMPLEMENTATION.
  METHOD GET_INSTANCE_FEATURES.
  READ ENTITIES OF ZI_CORSO_AC_MASTER_S IN LOCAL MODE
  ENTITY AC_MASTER_S
  ...
  MODIFY ENTITIES OF ZI_CORSO_AC_MASTER_S IN LOCAL MODE
  ENTITY AC_MASTER_S
...
CLASS LCL_SAVER IMPLEMENTATION.
  ...
  READ TABLE update-AC_MASTER_S INDEX 1 INTO DATA(all).
