...
METHOD READ_ENTITY.
DATA:
  ls_entity_key    TYPE zac_s_cds_log,
  ls_business_data TYPE zac_s_cds_log,
...
lo_resource = lo_client_proxy->create_resource_for_entity_set( 'ZAC_CDS_UNMAN_LOG' )->navigate_with_key( ls_entity_key ).
...
METHOD READ_LIST.
DATA:
  lt_business_data TYPE TABLE OF zac_s_cds_log,
  lo_client_proxy  TYPE REF TO /iwbep/if_cp_client_proxy,
...
* lt_range_LOGID TYPE RANGE OF zac_fieldname,
...
lo_request = lo_client_proxy->create_resource_for_entity_set( 'ZAC_CDS_UNMAN_LOG' )->create_request_for_read( ).
