CLASS zsu_cl_app_job DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zsu_cl_app_job IMPLEMENTATION.
  ...
  METHOD if_apj_rt_exec_object~execute.
    ...
    ENDLOOP.
    TRY.
        DATA(lo_appl_log) = cl_bali_log=>create_with_header(    header = cl_bali_header_setter=>create( object      = 'ZSULOGOBJECT'
                                                                                                        subobject   = 'ZSU_SUBOBJ_1'
