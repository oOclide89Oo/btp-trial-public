...
lo_client_proxy = CL_WEB_ODATA_CLIENT_FACTORY=>create_v2_local_proxy(
                    EXPORTING
                      is_service_key = VALUE #( service_id      = 'ZAC_SB_UNM_LOG'
...
lo_resource = lo_client_proxy->create_resource_for_entity_set( 'ZAC_CDS_UNM_LOG' )->navigate_with_key( ls_entity_key ).
...
lo_request = lo_client_proxy->create_resource_for_entity_set( 'ZAC_CDS_UNM_LOG' )->create_request_for_read( ).
