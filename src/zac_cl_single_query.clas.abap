CLASS zac_cl_single_query DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zac_cl_single_query IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    lt_business_data = zac_cl_single_log=>read_log_api( EXPORTING iv_log_id        = CONV zac_fname( lv_logid )
