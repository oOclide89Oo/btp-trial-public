CLASS LHC_SU_MASTER_S DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      GET_INSTANCE_FEATURES FOR INSTANCE FEATURES
        IMPORTING
          KEYS REQUEST requested_features FOR SU_MASTER_S
        RESULT result,
      SELECTTRANSPORT FOR MODIFY
        IMPORTING
          KEYS FOR ACTION SU_MASTER_S~selectTransport
        RESULT result.
ENDCLASS.

CLASS LHC_SU_MASTER_S IMPLEMENTATION.
  METHOD GET_INSTANCE_FEATURES.
  READ ENTITIES OF ZI_CORSO_SU_MASTER_S IN LOCAL MODE
  ENTITY SU_MASTER_S
  ...
  MODIFY ENTITIES OF ZI_CORSO_SU_MASTER_S IN LOCAL MODE
  ENTITY SU_MASTER_S
...
CLASS LCL_SAVER IMPLEMENTATION.
  ...
  READ TABLE update-SU_MASTER_S INDEX 1 INTO DATA(all).
