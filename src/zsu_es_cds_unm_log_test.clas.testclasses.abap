"!@testing SRVB:ZSU_ES_SB_UNM_LOG
...
METHOD READ_ENTITY.
DATA:
  ls_entity_key    TYPE ZSU_S_CDS_LOG,
  ls_business_data TYPE ZSU_S_CDS_LOG,
...
lo_resource = lo_client_proxy->create_resource_for_entity_set( 'ZSU_CDS_ES_UNM_LOG' )->navigate_with_key( ls_entity_key ).
...
METHOD READ_LIST.
DATA:
  lt_business_data TYPE TABLE OF ZSU_S_CDS_LOG,
  lo_client_proxy  TYPE REF TO /iwbep/if_cp_client_proxy,
...
lo_request = lo_client_proxy->create_resource_for_entity_set( 'ZSU_CDS_ES_UNM_LOG' )->create_request_for_read( ).
